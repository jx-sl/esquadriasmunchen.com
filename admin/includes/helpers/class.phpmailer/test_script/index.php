				...
				<input type="hidden" name="To_Name" value="<?php echo $value; ?>"> <?php $value = ( $_POST['To_Email'] != '' ) ? $_POST['To_Email'] : ''; ?>
					<input type="hidden" name="To_Email" value="<?php echo $value; ?>">
						...
						<input type="hidden" name="cc_Email" value="<?php echo $value; ?>">
							...
							value="<?php echo $value; ?>"> <?php $value = ( $_POST['Subject'] != '' ) ? $_POST['Subject'] : ''; ?>
								<input type="hidden" name="Subject"
								value="<?php echo $value; ?>"> <?php $value = ( $_POST['Message'] != '' ) ? $_POST['Message'] : ''; ?>
									<input type="hidden" name="Message"
									value="<?php echo $value; ?>"> <?php $value = ( $_POST['test_type'] != '' ) ? $_POST['test_type'] : 'mail'; ?>
										<input type="hidden" name="test_type"
										value="<?php echo $value; ?>"> <?php $value = ( $_POST['smtp_debug'] != '' ) ? $_POST['smtp_debug'] : $CFG['smtp_debug']; ?>
											<input type="hidden" name="smtp_debug"
											value="<?php echo $value; ?>"> <?php $value = ( $_POST['smtp_server'] != '' ) ? $_POST['smtp_server'] : $CFG['smtp_server']; ?>
												<input type="hidden" name="smtp_server"
												value="<?php echo $value; ?>"> <?php $value = ( $_POST['smtp_port'] != '' ) ? $_POST['smtp_port'] : $CFG['smtp_port']; ?>
													<input type="hidden" name="smtp_port"
													value="<?php echo $value; ?>"> <?php $value = ( $_POST['smtp_authenticate'] != '' ) ? $_POST['smtp_authenticate'] : $CFG['smtp_authenticate']; ?>
...
try {
  if ( !$mail->Send() ) {
    ...
    echo 'Message has been sent using <?php echo strtoupper($_POST['test_type']); ?>
		<br /><br />';
  }
} catch (phpmailerAppException $e) {
  $errorMsg[] = $e->errorMessage();
...
td.colrite {
	...
	<form method="POST" enctype="multipart/form-data">
					...
					<table border="1" width="450" cellspacing="0" cellpadding="5"
						...
						<tr>
							...
							<td class="colrite"><input type="text" name="From_Name"
								value="<?php echo $value; ?>" style="width: 99%;">
						...
						<tr>
							<td class="colleft">cc Email Addresses <small>(separate with
									commas)</small>
							</td>
							<?php $value = ( $_POST['cc_Email'] != '' ) ? $_POST['cc_Email'] : ''; ?>
						...
						<tr>
							<td class="colleft">Message<br /> <small>If blank, will use
									content.html</small>
							</td>
						...
						<tr>
							...
							<td class="colrite"><table>
									<tr>
										...
										<?php echo ( $_POST['test_type'] == 'mail') ? 'checked' : ''; ?>>
									...
									<tr>
										...
										<?php echo ( $_POST['test_type'] == 'sendmail') ? 'checked' : ''; ?>>
									...
									<tr>
										...
										<?php echo ( $_POST['test_type'] == 'qmail') ? 'checked' : ''; ?>>
									...
									<tr>
										...
										<?php echo ( $_POST['test_type'] == 'smtp') ? 'checked' : ''; ?>>
					...
					<table border="1" width="450" cellspacing="0" cellpadding="5"
						...
						<tr>
							...
							<td class="colrite"><select size="1" name="smtp_debug">
									<option <?php echo ( $value == '0') ? 'selected' : ''; ?>
										value="0">0 - Disabled</option>
									<option <?php echo ( $value == '1') ? 'selected' : ''; ?>
										value="1">1 - Errors and Messages</option>
									<option <?php echo ( $value == '2') ? 'selected' : ''; ?>
										value="2">2 - Messages only</option>
							</select></td>
						</tr>
						<tr>
		...
		<br /> Test will include two attachments, plus one of the attachments
		is used as an inline graphic in the message body.
		<br />
		<br />
